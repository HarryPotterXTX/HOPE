...
```
$y=0.38+0.54(x_1-0.5)+0.51(x_2-0.5)+0.53(x_1-0.5)^2+0.06(x_1-0.5)(x_2-0.5)+0.03(x_2-0.5)^2=0.01-0.02 x_1+0.45 x_2+0.53 x_1^2+0.06 x_1 x_2+0.03 x_2^2\approx 0.45 x_2+0.53 x_1^2$
...
-0.07(x_1+0.5)(x_2+0.5)+0.02(x_2+0.5)^2=-0.03-0.05 x_1+0.48 x_2+0.50 x_1^2-0.07 x_1 x_2+0.02 x_2^2\approx 0.48 x_2+0.50 x_1^2$
